...
import 'package:bakaata/common/widgets/image_text/image_text_vertical.dart';
...
import 'package:bakaata/common/widgets/shimmers/category_shimmer.dar.dart';
import 'package:bakaata/common/widgets/shimmers/search_category_shimmer.dart';
...
import 'package:bakaata/features/shop/controllers/search_controller.dart';
              ...
              children: brandController.allBrands
                ...
                child: Padding(
                  ...
                  child: TVerticalImageAndText(
                    ...
                    title: brand.name,
                    isNetworkImage: true,
                    textColor: THelperFunction.isDarkMode(context) ? TColors.white : TColors.dark,
