...
class TDummyData {
  ...
  static final List<BrandModel> brands = [
    BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes', productsCount: 265, isFeatured: true),
    ...
    BrandModel(id: '6', image: TImages.zaraLogo, name: 'Canfa', productsCount: 36, isFeatured: true),
  ...
  static final List<ProductModel> products = [
    ProductModel(
      ...
      description: 'Green sports shoe',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes', productsCount: 265, isFeatured: true),
      ...
      productVariations: [
        ProductVariationModel(
            ...
            description: 'This is a Product description for Green sports shoe.',
    ...
    ProductModel(
      ...
      description:
      'This is a Product description for Blue Sleeve less vest. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '6', image: TImages.zaraLogo, name: 'Canfa'),
    ...
    ProductModel(
      id: '005',
      title: 'Air Jordon Shoes',
      stock: 15,
      price: 35,
      isFeatured: false,
      thumbnail: TImages.productImage10,
      description: 'Air Jordon Shoes for running. Quality product, Long Lasting',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes', productsCount: 265, isFeatured: true),
    ...
    ProductModel(
      id: '009',
      title: 'Jordon 19 Blue',
      stock: 15,
      price: 400,
      isFeatured: false,
      thumbnail: TImages.productImage19,
      description:
      'This is a Product description for Air Jordon. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
    ...
    ProductModel(
      id: '011',
      title: 'Air Max Red & Black',
      stock: 15,
      price: 600,
      isFeatured: true,
      thumbnail: TImages.productImage21,
      description:
      'This is a Product description for Air Max. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
    ...
    ProductModel(
      id: '012',
      title: 'Basketball shoes Black & Green',
      stock: 15,
      price: 600,
      isFeatured: false,
      thumbnail: TImages.productImage22,
      description:
      'This is a Product description for Basketball shoes. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
    ...
    ProductModel(
      id: '013',
      title: 'wild horse shoes',
      stock: 15,
      price: 600,
      isFeatured: false,
      thumbnail: TImages.productImage23,
      description:
      'This is a Product description for wild horse shoes. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
    ...
    ProductModel(
      id: '014',
      title: 'Track suit red',
      stock: 15,
      price: 500,
      isFeatured: true,
      thumbnail: TImages.productImage26,
      description:
      'This is a Product description for Track suit red. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
    ...
    ProductModel(
      id: '015',
      title: 'Track suit Black',
      stock: 15,
      price: 200,
      thumbnail: TImages.productImage24,
      description:
      'This is a Product description for Track suit Black. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
    ...
    ProductModel(
      id: '016',
      title: 'Track suit Blue',
      stock: 15,
      price: 100,
      thumbnail: TImages.productImage25,
      description:
      'This is a Product description for Track suit Blue. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
    ...
    ProductModel(
      id: '017',
      title: 'Track suit Parrot Green',
      stock: 15,
      price: 350,
      thumbnail: TImages.productImage27,
      description:
      'This is a Product description for Track suit Parrot Green. There are more things that can be added but i am just practicing and nothing else.',
      brand: BrandModel(id: '1', image: TImages.nikeLogo, name: 'Serena Shoes'),
